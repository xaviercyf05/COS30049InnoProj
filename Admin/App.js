...
import AnnounceScreen from './adminAnnounce';
import ModuleScreen from './adminModule';
    ...
    <View style={styles.header}>
      ...
      <View style={styles.headerRight}>
        ...
        <TouchableOpacity onPress={() => {
          ...
          if (!notificationVisible) setShowAllNotifications(false); // reset to 3 when reopening
        }}>
          <View>
            <Image
          ...
          <View style={styles.topSection}>
            ...
            <View style={styles.menuSection}>
              ...
              <TouchableOpacity
                ...
                onPress={() => { setMenuVisible(false); navigation.navigate('Announcements'); }}
              >
                <Text style={styles.dropdownText}>📢 Announcements</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.dropdownItem}
                onPress={() => { setMenuVisible(false); navigation.navigate('Modules'); }}
              >
...
const styles = StyleSheet.create({
  ...
  username: { fontWeight: '600', fontSize: 16, color: '#3A4D39' },
  menuSection: { marginVertical: 10 },
  dropdownItem: { paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#F5F5F0' },
