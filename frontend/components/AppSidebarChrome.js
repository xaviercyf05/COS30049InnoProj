...
const DEFAULT_PROFILE_IMAGE = 'https://static.vecteezy.com/system/resources/previews/036/280/651/original/default-avatar-profile-icon-social-media-user-image-gray-avatar-icon-blank-profile-silhouette-illustration-vector.jpg';
...
function AppSidebarChrome({ navigation, route, title, children }) {
	...
	const loadProfile = useCallback(async () => {
		...
		try {
			...
			const notificationsResponse = await requestProfileApi('/api/v1/notifications', token, {
				method: 'GET',
			}).catch(() => null);
		...
		<View style={styles.root}>
			...
			>
				...
				<View style={styles.titleBlock}>
					...
					<Text style={styles.appSubtitle}>SFC Training • {isAdmin ? 'Administrator' : 'User'}</Text>
				</View>
					...
					>
						<View style={styles.sidebarHeader}>
							<View style={styles.userSection}>
								<Image source={profileImageSource} style={styles.sidebarImage} />
